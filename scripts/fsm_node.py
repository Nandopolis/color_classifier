...
class FSM(object):
    ...
    def __init__(self):
        ...
        self.machine.add_transition('interseccion', 'seguir_linea_1_f', 'soltar_cubo', after='abrir_brazo')
        self.machine.add_transition('cubo_liberado', 'soltar_cubo', 'media_vuelta_inicio', conditions='negro', after='girar')
